...
public class GeoLocationManager extends Manager {
    ...
    public void sendGeoLocationToJid(GeoLocation geoLocation, String jid) throws InterruptedException,
                    NotConnectedException {

        final XMPPConnection connection = connection();

        Message geoLocationMessage = new Message();
        geoLocationMessage.setTo(jid);
